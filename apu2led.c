/* 
 * apu2led - show network traffic on apu2 LEDs
 * Copyright (c) 2016 Christian Herzog <daduke@daduke.org>
...
const char *banner = 
		"apu2led v1.0 - (c) 2016 Christian Herzog <daduke@daduke.org>\n"
		"based on ifled by Mattias Wadman <napolium@sudac.org>\n"
...
int main(int argc, char *argv[]) {
	...
	int led;
	for (led=0;led < 3;led++) {
		sprintf(fd, "/sys/class/leds/apu2:%d/brightness", led+1);
